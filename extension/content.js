...
const CONFIGS = {
  'linkedin.com': {
    ...
    detailPanel: '.jobs-unified-top-card, .job-details-jobs-unified-top-card',
    detailTitle: '.job-details-jobs-unified-top-card__job-title h1, .t-24, h1',
    detailCompany: '.job-details-jobs-unified-top-card__company-name a, .jobs-unified-top-card__company-name a, .app-aware-link',
    detailDescription: '.jobs-description__content, .jobs-box__html-content, #job-details',
    detailInsert: '.jobs-unified-top-card__primary-description-container, .job-details-jobs-unified-top-card__primary-description, .jobs-unified-top-card__subtitle',
  },
  'jobberman.com': {
    cards: 'article.job-card, .job-list-item',
    title: 'h2, h3, .job-title a',
    company: '.company-name, .employer',
    description: '.job-description, .summary',
    insertAfter: '.company-name, .employer, h3',
    detailPanel: '.job-detail-container, .single-job-detail',
    detailTitle: 'h1.job-title, h1',
    detailCompany: '.company-name, .employer-name',
    detailDescription: '.job-description',
    detailInsert: '.company-name, .employer-name',
  },
  'indeed.com': {
    cards: '.job_seen_beacon, .tapItem',
    title: 'h2.jobTitle span',
    company: '.companyName',
    description: '.job-snippet',
    insertAfter: '.companyName',
    detailPanel: '.jobsearch-JobComponent, [data-testid="jobsearch-ViewJobLayout"]',
    detailTitle: 'h1',
    detailCompany: '[data-testid="inlineHeader-companyName"] a, .jobsearch-InlineCompanyRating a',
    detailDescription: '#jobDescriptionText',
    detailInsert: '[data-testid="inlineHeader-companyName"], .jobsearch-InlineCompanyRating',
  },
  'myjobmag.com': {
    cards: '.job-listing, article',
    title: 'h2 a, h3 a',
    company: '.company',
